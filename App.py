...
label2 = tk.Label(root, font='Helvetica 12 bold', text="Deleted files:")
src_button = tk.Button(root, font='Helvetica 12 bold',height=4,width=20, text='Source directory', command=lambda: select_dir(src_entry))
src_button2 = tk.Button(root, font='Helvetica 12 bold',height=4,width=15, text='Check from', command=lambda: select_dir(src_entry))

src_entry = tk.Entry(root)  
dest_button = tk.Button(root, font='Helvetica 12 bold',height=4,width=20, text='Destination directory', command=lambda: select_dir(dest_entry))
dest_button2 = tk.Button(root, font='Helvetica 12 bold',height=4,width=15, text='DELETE from', command=lambda: select_dir(dest_entry))
...
confirm_button = tk.Button(root, font='Helvetica 12 bold',height=4,width=10, text='Confirm', command=lambda: copy_or_move_image_action(src_entry, dest_entry, action))
confirm_button2 = tk.Button(root, font='Helvetica 12 bold',height=4,width=10, text='Confirm', command=lambda: find_duplicate_and_delete_action(src_entry, dest_entry))
def shutdown():
...
button5 = tk.Button(root, background = "#61595D", text="Shun down", command=shutdown, width=320)
...
def show_main_page():
    ...
    button5.pack(side= TOP, expand = True, fill = BOTH, padx=2, pady=1)
...
def select_dir(entry):
    ...
    dirname = tk.filedialog.askdirectory(initialdir='/media/sami')
...
def select_src_dir():
    ...
    src_dir = filedialog.askdirectory(initialdir='/media/sami')
...
def select_dest_dir():
    ...
    dest_dir = filedialog.askdirectory(initialdir='/media/sami')
